...
public class RulesBase implements Rules {
    public void printcache(){
    	...
    	for (Object ob : cache.keySet()) {
    		stb.append(ob.toString() + " \t\t\t= " + cache.get(ob).toString() + "\r\n");
		}
//    	SystemHelp.printlnMap(stb.toString());
		System.out.println(stb);
    	
//    	SystemHelp.printlnMap(cache,"digestor-cache.txt");
    }
