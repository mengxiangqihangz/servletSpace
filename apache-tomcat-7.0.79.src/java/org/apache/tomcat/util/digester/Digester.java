...
public class Digester extends DefaultHandler2 {
		...
		if (className != null) {
			...
			for (int i = 0; i < cls.length; i++) {
				try {
					...
					propertySource = (IntrospectionUtils.PropertySource) clazz
							.newInstance();
					break;
				} catch (Throwable t) {
	...
	public void startElement(String namespaceURI, String localName,
		...
		boolean debug = log.isDebugEnabled();
		System.out.println("namespaceURI = " + namespaceURI + ", localName = " + localName + ", qName = " + qName + ", attributes = " + list.getValue(0) + "        ");
...
//		SystemHelp.println(rules+"\r\n");
		 ...
		 */
//		if(list.getValue(0).equals("org.apache.catalina.mbeans.GlobalResourcesLifecycleListener")){
